...
#else
    public simif_nf_t, public firesim_top_t
#endif
{
    public:
#ifdef RTLSIM
        firesim_nf_t(int argc, char** argv): firesim_top_t(argc, argv) {};
#else
        firesim_nf_t(int argc, char** argv): simif_nf_t(argc, argv), firesim_top_t(argc, argv) {};
#endif
};

int main(int argc, char** argv) {
  try {
    firesim_nf_t firesim(argc, argv);
