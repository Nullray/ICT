...
if {${::board} == "fidus"} {
  ...
  # Create instance: pr_decoupler, and set properties
  set pr_decoupler [ create_bd_cell -type ip -vlnv xilinx.com:ip:pr_decoupler:1.0 pr_decoupler ]
...
#=============================================
  ...
  # Create instance: role_cell
  set role_cell [create_bd_cell -type module -reference role_bb role_cell]
...
#=============================================
  ...
  # Role module clock
  connect_bd_net -net pl_clk2_out [get_bd_pins zynq_mpsoc/pl_clk2] \
...
#=============================================
  ...
  connect_bd_net -net pr_decoupler_rp_resetn_RST [get_bd_pins pr_decoupler/rp_resetn_RST] \
        [get_bd_pins role_cell/aresetn]
...
#=============================================
  ...
  connect_bd_intf_net -intf_net axi_ic_mmio_M03_AXI [get_bd_intf_pins axi_ic_mmio/M03_AXI] \
        [get_bd_intf_pins pr_decoupler/s_axi_reg]
...
#=============================================
  ...
  # Role module
  create_bd_addr_seg -range 0x01000000 -offset 0x90000000 [get_bd_addr_spaces zynq_mpsoc/Data] [get_bd_addr_segs role_cell/axi_mmio/reg0] SEG_role_cell_reg

  # PR decoupler
  create_bd_addr_seg -range 0x00010000 -offset 0x81000000 [get_bd_addr_spaces zynq_mpsoc/Data] [get_bd_addr_segs pr_decoupler/s_axi_reg/Reg] SEG_pr_decoupler_Reg
